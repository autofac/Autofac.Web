...
public abstract class DependencyInjectionModule : IHttpModule
{
    ...
    public void Init(HttpApplication context)
    {
        ...
        _containerProviderAccessor = context as IContainerProviderAccessor ?? throw new InvalidOperationException(DependencyInjectionModuleResources.ApplicationMustImplementAccessor);
